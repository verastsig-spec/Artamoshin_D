...
class RandomTaskApp:
    def __init__(self, root):
        ...
        self.predefined_tasks = [
            ...
            {"text": "Составить план на завтра", "type": "Работа"}
        ]
    ...
    def setup_ui(self):
        ...
        self.history_listbox.pack(pady=5, fill=tk.BOTH, expand=True, padx=20)
    ...
    def generate_task(self):
        ...
        self.save_history()
        self.update_history_display()
        messagebox.showinfo("Новая задача", f"Ваша задача: {task['text']} ({task['type']})")
